...
(function(){
    ...
    app.controller('CalculatorController',['$scope',function($scope){
        ...
        $scope.calculate = function(){
            ...
            $scope.inc_cost = ((($scope.inc_wattage * total_hours)/100) * cost).toFixed(2);
            $scope.hal_cost = ((($scope.hal_wattage * total_hours)/100) * cost).toFixed(2);
            $scope.cfl_cost = ((($scope.cfl_wattage * total_hours)/100) * cost).toFixed(2);
            $scope.led_cost = ((($scope.led_wattage * total_hours)/100) * cost).toFixed(2);
        }
